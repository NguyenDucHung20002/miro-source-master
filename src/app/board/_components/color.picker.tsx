...
export const ColorPicker = ({ onChange }: IColorPickerProps) => {
  return (
    <div className="flex flex-wrap gap-2 items-center max-w-[164px] pr-2 border-r border-neutral-200 mr-1">
      ...
      <ColorButton color={{ r: 30, g: 39, b: 46 }} onClick={onChange} />
...
export const ColorButton = ({ onClick, color }: IColorButtonProps) => {
  return (
    <button
